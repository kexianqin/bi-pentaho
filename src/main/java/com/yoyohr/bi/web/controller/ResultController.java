...
public class ResultController {
    ...
    public QueryResult abc() throws UnanthenticatedException, IOException, URISyntaxException {
        PentahoClient client =new PentahoClient();
        return client.doQuery("home/youpin/iHateYou.cda","201707031722","youpin_kdwh_srm","select non empty[operator.operator].[operator_key].members on 1,[Measures].[action_numbers] on 0 from [youpin_kdwh_expense]");
    }
