...
public class OlapDiscoverResource extends BaseResource {
    ...
    public String getUriOfGetRestCubeMetadata(SaikuCube saikuCube) {
        return "/discover/" + saikuCube.getConnection() + "/" + saikuCube.getCatalog() + "/" + saikuCube.getSchema()
                + "/" + saikuCube.getName() + "/metadata";
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        log.info(resource.parseOlapConnections().toString());
    }
}
